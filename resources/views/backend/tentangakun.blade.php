    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div style="text-align:center;">
                <a href="/admin" type="cancel" class="btn btn-danger">Kembali</a>
                <a href="/admin/tentangakun/editprofil" class="btn btn-info">Edit Profil</a>
                <a href="/admin/tentangakun/ubahpassword" type="cancel" class="btn btn-info">Ubah Password</a>
            </div>
        </div>
        </form>
        </div>
